      ...
      try {
        ...
        if (response.data.success && response.data.data.length > 0) {
          ...
          setContactInfo([
            ...
            { icon: Phone, title: 'Phone', content: info.phoneNumber },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Have questions? We'd love to hear from you. Drop us a message and we’ll get back shortly.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
          {contactInfo.map((info, idx) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-600 text-white 
